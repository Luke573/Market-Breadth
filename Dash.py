...
4. **Realized instead of implied data:** I used realized volatility and correlation, which is what actually happened in the market. Traders care more about implied vol and correlation, the market's forward-looking pricing of those from the options market. A production version would pull that instead, but it needs options data I didn't have.
""")
